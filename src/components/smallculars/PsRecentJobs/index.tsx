...
import RecentJobsCard from "src/components/smallculars/Cards/RecentJobsCard";
import { Text } from "src/components/childs-components/Text";
import { Table } from "src/components/childs-components/Table";
